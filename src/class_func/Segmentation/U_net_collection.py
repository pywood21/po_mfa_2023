...
def UNet(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True):
    ...
    # DownRes 4
    conv_16 = conv_block(pool_16, FILTER_SIZE, 8*FILTER_NUM, 0.5, batch_norm)
    ...
    up_16 = layers.Conv2D(512, (2,2), padding="same")(up_16)
    up_16 = layers.Activation('relu')(up_16)
    up_16 = layers.concatenate([up_16, conv_16], axis=3)
    up_conv_16 = conv_block(up_16, FILTER_SIZE, 8*FILTER_NUM, dropout_rate, batch_norm)
    
    # UpRes 7
    up_32 = layers.UpSampling2D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE), data_format="channels_last")(up_conv_16)
    up_32 = layers.Conv2D(256, (2,2), padding="same")(up_32)
    up_32 = layers.Activation('relu')(up_32)
    up_32 = layers.concatenate([up_32, conv_32], axis=3)
    up_conv_32 = conv_block(up_32, FILTER_SIZE, 4*FILTER_NUM, dropout_rate, batch_norm)
    
    # UpRes 8
    up_64 = layers.UpSampling2D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE), data_format="channels_last")(up_conv_32)
    up_64 = layers.Conv2D(128, (2,2), padding="same")(up_64)
    up_64 = layers.Activation('relu')(up_64)
    up_64 = layers.concatenate([up_64, conv_64], axis=3)
    up_conv_64 = conv_block(up_64, FILTER_SIZE, 2*FILTER_NUM, dropout_rate, batch_norm)
    
    # UpRes 9
    up_128 = layers.UpSampling2D(size=(UP_SAMP_SIZE, UP_SAMP_SIZE), data_format="channels_last")(up_conv_64)
    up_128 = layers.Conv2D(64, (2,2), padding="same")(up_128)
    up_128 = layers.Activation('relu')(up_128)
    up_128 = layers.concatenate([up_128, conv_128], axis=3)
    up_conv_128 = conv_block(up_128, FILTER_SIZE, FILTER_NUM, dropout_rate, batch_norm)

    # 1*1 convolutional layers
    conv_final = layers.Conv2D(2, (3,3), padding="same")(up_conv_128)
    conv_final = layers.Activation('relu')(conv_final)
    conv_final = layers.Conv2D(NUM_CLASSES, (1,1), padding="same")(conv_final)
