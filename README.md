...
| ------------------- | ------------------------------------------------------------ | ------------ | ----------- |
| p.2, col.2, line3-7 | **Incorrect**: we aimed to simultaneously measure cell-by-cell MFA and cell anatomy, and to elucidate the relationship between the combination of  POM-based MFA measurement and semantic segmentation-based cell boundary prediction.<br />**correct**: we aimed to simultaneously measure cell-by-cell MFA and cell anatomy of hardwoods, and to elucidate the relationship between their cell anatomy and MFA by the combination of  POM-based MFA measurement and semantic segmentation-based cell boundary prediction. | 2023/07/05   | Yusuke Kita |
